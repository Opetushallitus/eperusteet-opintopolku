namespace KieliService {
    ...
    export let SISALTOKIELET = ["fi", "sv", "se", "ru", "en"];
    ...
    export const UIKIELET = ["fi", "sv", "en"];
...
angular
    ...
    //     $scope.setUiKieli = async (kielikoodi) =>  await KieliService.setUiKieli(kielikoodi);
    //

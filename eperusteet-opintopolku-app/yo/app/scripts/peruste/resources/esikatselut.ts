...
angular
    ...
    .factory("LukioPerusteenOsat", function($resource, epEsikatseluResource) {
        return $resource(
            epEsikatseluResource.PERUSTEET + "/suoritustavat/lukiokoulutus/sisalto",
            {
                perusteId: "@id"
            },
            {
    ...
    .factory("LukioTekstikappale", function($resource) {
        return $resource(
            "/eperusteet-service/api/perusteenosat/viite/:viiteId",
            {
                viiteId: "@id"
            },
            {
    ...
    .factory("LukioYleistiedot", function($resource, epEsikatseluResource) {
        ...
        return $resource(
            ...
            },
            {
                ...
                getAihekokonaisuuksienYleinen: {
                    method: "GET",
                    url: baseUrl + "/aihekokonaisuudet/yleiskuvaus",
                    cache: true
                },
                getAihekokonaisuudet: {
                    method: "GET",
                    isArray: true,
                    url: baseUrl + "/aihekokonaisuudet",
                    cache: true
                },

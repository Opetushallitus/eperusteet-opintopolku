...
epOpintopolkuApp
  .directive('tutke2kentat', function () {
    return {
      restrict: 'AE',
      templateUrl: 'views/esitys/directives/tutke2kentat.html',
      scope: {
  ...
  .controller('Tutke2KentatController', function ($scope, $state, Tutke2Osa, Tutke2OsaData,
    Varmistusdialogi, Utils, Lukitus, $q, YleinenData) {
  ...
  .factory('Tutke2Osa', function ($q, TutkinnonOsanOsaAlue, $stateParams, Kieli) {
    ...
    Tutke2OsaImpl.prototype.fetch = function () {
      ...
      if (versio) {
        // TODO ensure we don't go here
        console.warn('requesting tutke2 versio');
      } else {

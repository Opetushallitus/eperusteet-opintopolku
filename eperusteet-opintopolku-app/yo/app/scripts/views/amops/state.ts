...
angular.module("app").config($stateProvider =>
    $stateProvider.state("root.amops", {
        url: "/amops/:opsId",
        ...
        resolve: {
            ...
            ktInfo: (julkinen, $stateParams) =>
                julkinen
                    .one("opetussuunnitelmat", $stateParams.opsId)
                    .one("koulutustoimija")
                    .get(),
            ...
            "": {
                ...
                controller: ($scope, $state, $stateParams, ops, otsikot, sisaltoRoot, $window, $location, ktId, Utils) => {
                    ...
                    $scope.$on("$stateChangeSuccess", (event, toState, toParams, fromState, fromParams) => {
                        ...
                        $scope.muruPath = _(
                            _.rest(path).reduce(
                                (acc: Array<string>, next: string) => _.append(acc, _.last(acc) + "." + next),
                                ["root"]
                            )
                        )

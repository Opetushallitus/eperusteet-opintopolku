...
const opetussuunnitelmanOppiaineet = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto('oppiaineet');
});

const perusteenOppiaineetByTunniste = computed(() => {
  return _.chain(props.opetussuunnitelmaDataStore.getJulkaistuPerusteSisalto('perusopetus.oppiaineet'))
    .map(oppiaine => {
      return [
        oppiaine,
...
const opetussuunnitelmanVuosiluokkakokonaisuudet = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto('vuosiluokkakokonaisuudet');
});

const vuosiluokat = computed(() => {
  return _.chain(_.map(props.opetussuunnitelmaDataStore.getJulkaistuSisalto('oppiaineet'), 'oppiaine'))
...
const laajaalaisetOsaamiset = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuPerusteSisalto('perusopetus.laajaalaisetosaamiset');
});

const perusteenVuosiluokkakokonaisuudet = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuPerusteSisalto('perusopetus.vuosiluokkakokonaisuudet');
});
...
const termit = computed(() => {
  return props.opetussuunnitelmaDataStore.kaikkiTermit;
});

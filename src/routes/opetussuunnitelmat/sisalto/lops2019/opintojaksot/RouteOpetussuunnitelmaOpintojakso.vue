...
const laajaAlaisetOsaamiset = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto('laajaAlaisetOsaamiset');
});

const poppiaineet = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto('paikallisetOppiaineet');
});

const opintojaksot = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto('opintojaksot');
});
...
const oppiaineet = computed(() => {
  return [
    ...props.opetussuunnitelmaDataStore.getJulkaistuPerusteSisalto('lops2019.oppiaineet'),
...
const oppiaineetNavigationByUri = computed(() => {
  return props.opetussuunnitelmaDataStore.oppiaineetNavigationByUri;
});

...
const props = defineProps({
  ammatillistenTiedotteetStore: {
    type: Object as () => AmmatillistenTiedoteStore,
    required: true,
  },
...
onMounted(async () => {
  props.ammatillistenTiedotteetStore.init({ koulutusTyyppi: ammatillisetkoulutusryhmat.value.koulutustyypit });
  props.ammatillistenTiedotteetStore.fetch();
});

const tiedotteet = computed(() => {
  return props.ammatillistenTiedotteetStore.tiedotteet.value;
});

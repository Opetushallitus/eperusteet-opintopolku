...
const oppiaine = computed(() => {
  return props.perusteDataStore.getJulkaistuPerusteSisalto({ id: oppiaineId.value });
});
...
const laajaAlaisetOsaamisetById = computed(() => {
  return _.keyBy(props.perusteDataStore.getJulkaistuPerusteSisalto('aipe.laajaalaisetosaamiset'), 'id');
});

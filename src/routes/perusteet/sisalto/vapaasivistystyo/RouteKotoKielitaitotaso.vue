...
const perusteDataStore = getCachedPerusteStore(route.params.perusteId, route.params.revision);
const perusteenOsaStore = createPerusteOsaStore(perusteDataStore, route.params.kotokielitaitotasoId);

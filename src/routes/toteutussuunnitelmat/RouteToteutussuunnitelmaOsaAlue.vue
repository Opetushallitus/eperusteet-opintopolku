...
const osaalue = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisalto({ id: osaalueId.value });
});
...
const perusteOsaAlue = computed(() => {
  return _.chain(props.opetussuunnitelmaDataStore.perusteidenTutkinnonOsat)

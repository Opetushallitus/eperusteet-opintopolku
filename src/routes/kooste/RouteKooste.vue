    ...
    <div>
      <div class="w-full">
        ...
        >
          ...
          <div
            v-if="julkaistutEraantyneetPerusteet && julkaistutEraantyneetPerusteet.length > 0"
            class="w-full"
          >
            <ep-button
              link
        ...
        <div v-if="opasStore && ohjeet?.length || 0 > 0">

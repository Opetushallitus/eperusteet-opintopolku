...
import { useToteutussuunnitelmaDataStore } from './stores/ToteutussuunnitelmaDataStore';
  ...
  routes: [{
    ...
    children: [
      ...redirects,
      {
        ...
        beforeEnter: async (to, from, next) => {
          await opetussuunnitelmaCacheStore.addOpetussuunnitelmaStore(
            useToteutussuunnitelmaDataStore,
            'ops',
            to.params.toteutussuunnitelmaId,
            to.params.revision,
          );
          next();
        },
        ...
        beforeEnter: async (to, from, next) => {
          await opetussuunnitelmaCacheStore.addOpetussuunnitelmaStore(
            useOpetussuunnitelmaDataStore,
            'totsu',
            to.params.opetussuunnitelmaId,
            to.params.revision,
          );
          next();
        },

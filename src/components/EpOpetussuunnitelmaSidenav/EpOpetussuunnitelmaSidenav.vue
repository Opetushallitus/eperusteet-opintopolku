...
const setValue = (value) => {
  ...
  if (value.length === 0 || value.length > 2) {
    props.opetussuunnitelmaDataStore.updateFilter({
...
const sidenavLoading = computed(() => {
  return props.opetussuunnitelmaDataStore.sidenavLoading;
});

const treeData = computed(() => {
  return props.opetussuunnitelmaDataStore.filteredSidenav;
});

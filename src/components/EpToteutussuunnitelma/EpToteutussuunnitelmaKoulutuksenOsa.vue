...
const laajaAlaisetOsaamiset = computed(() => {
  return props.opetussuunnitelmaDataStore.getJulkaistuSisaltoList({ 'tyyppi': 'laajaalainenosaaminen' });
});
...
const perusteenOsa = computed(() => {
  if (props.sisaltoviite.perusteenOsaId) {
    return props.opetussuunnitelmaDataStore.getJulkaistuPerusteSisalto({ id: props.sisaltoviite.perusteenOsaId });
  }
  else {

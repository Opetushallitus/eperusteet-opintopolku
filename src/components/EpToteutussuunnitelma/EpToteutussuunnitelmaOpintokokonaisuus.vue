<template>
  <div>
    ...
    <div v-if="opintokokonaisuus.tavoitteidenKuvaus" class="flex flex-wrap">
      <div class="w-full">
    ...
    <div v-if="opintokokonaisuus.arvioinninKuvaus" class="flex flex-wrap">
      <div class="w-full">
    ...
    <template v-if="opintokokonaisuus.osaamismerkkiKappale && (opintokokonaisuus.osaamismerkkiKappale.kuvaus || osaamisMerkkiKoodit.length > 0)">
      ...
      <div v-if="opintokokonaisuus.osaamismerkkiKappale.kuvaus" class="flex flex-wrap">
        <div class="w-full">
          <h4 class="mb-4">
      ...
      <div v-if="osaamisMerkkiKoodit.length > 0" class="flex flex-wrap">
        <div class="w-full">
          <EpOsaamismerkit
